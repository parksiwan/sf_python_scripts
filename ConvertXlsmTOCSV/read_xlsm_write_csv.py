...
#wb = load_workbook('Alex 2019 31 JULY AUG D01-02.xlsx', read_only=True, data_only=True)
wb = load_workbook('Alex 2019 31 JULY AUG D01-02.xlsx')
...
for row in ws0.iter_rows(min_row=4, max_col=20, max_row=ws0.max_row, values_only=True):
